...
router.post(
  '/login',
  (req, res, next) => {
    console.log('📥 Solicitud recibida en /auth/login') // Debug para verificar la solicitud
    next()
  },
  validateAuth,
  login
...
router.post(
  '/sign-out',
  (req, res, next) => {
    console.log('📥 Solicitud recibida en /auth/sign-out') // Debug para verificar la solicitud
    next()
  },
  signOut
)
